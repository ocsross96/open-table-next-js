export default function Reviews() {
  return (
    <div>
      <h1 className="borber-b mt-10 mb-7 pb-5 text-3xl font-bold">What 100 people are saying</h1>
      <div>
        {/* REVIEW CARD */}
            ...
            <div className="ml-10 w-5/6">
              ...
              <div className="mt-5">
                <p className="text-lg font-light">
                  Laurie was on top of everything! Slow night due to the snow storm so it worked in our favor to have
                  more one on one with the staff. Delicious and well worth the money.
                </p>
              </div>
            </div>
          </div>
