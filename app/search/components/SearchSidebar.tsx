    ...
    <div className="w-1/5">
      ...
      <div className="mt-3 pb-4">
        ...
        <div className="flex">
          ...
          <button className="w-full border-r border-t border-b p-2 text-reg font-light">$$</button>
          <button className="w-full rounded-r border-r border-t border-b p-2 text-reg font-light">$$$</button>
        </div>
      </div>
    </div>
  );
